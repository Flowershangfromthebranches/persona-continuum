...
def test_merge_targeted_repair_artifact_includes_new_source_ids():
    current = {
        ...
        "source_ids": ["src_1"],
        "claims": [{"content": "Existing claim", "source_id": "src_1", "claim_type": "historical_inference", "confidence": 0.9}],
        "memories": [],
    ...
    repaired = {
        ...
        "dimension": "works_and_views",
        "source_ids": ["src_2"],
        "claims": [{"content": "New repaired claim", "source_id": "src_2", "claim_type": "historical_inference", "confidence": 0.85}],
        "memories": [],
